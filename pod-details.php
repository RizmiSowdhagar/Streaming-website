...
<form style="position: absolute;left: 1px;" action="pod-search.php" method="POST">
            ...
            <?php
              ...
              while($row = $query->fetch_assoc()){
                ...
                "<tr>
                  ...
                  echo"<form action='pod-edit_delete_modal.php method='POST'>";
                  echo"<td>
                  ...
                  echo"</form>";
                echo"</tr>";
                include('pod-edit_delete_modal.php');
              }
