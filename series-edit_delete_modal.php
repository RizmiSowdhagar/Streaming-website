    ...
    <div class="modal-dialog">
        <div style="height: 700px;"  class="modal-content">
            <div class="modal-header">
                ...
                <center><h4 class="modal-title" id="myModalLabel">Edit Episode</h4></center>
            </div>
            <div class="modal-body">
			<div style="background-image: none;border: none;" class="container-fluid">
			<form method="POST" action="series-edit.php">
...
<div class="modal fade" id="delete_<?php echo $row['mid']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <center><h4 class="modal-title" id="myModalLabel">Delete Episode</h4></center>
            </div>
            <div class="modal-body">	
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span> Cancel</button>
                <a href="series-delete.php?id=<?php echo $row['name']; ?>" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Yes</a>
            </div>
