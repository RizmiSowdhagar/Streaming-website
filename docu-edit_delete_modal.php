    ...
    <div class="modal-dialog">
        <div style="height: 700px;"  class="modal-content">
            <div class="modal-header">
                ...
                <center><h4 class="modal-title" id="myModalLabel">Edit Documentary</h4></center>
            </div>
            <div class="modal-body">
			<div style="background-image: none;border: none;" class="container-fluid">
			<form method="POST" action="docu-edit.php">
				...
				<div class="row form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" name="name" value="<?php echo ucwords($row['name']); ?>">
					</div>
				</div>
				<div class="row form-group">
					<div class="col-sm-2">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" name="genre" value="<?php echo ucwords($row['genre']); ?>">
					</div>
				</div>
				<div class="row form-group">
					<div class="col-sm-2">
				...
				<div class="row form-group">
					<div class="col-sm-2">
						<label class="control-label modal-label">Upload Documentary:</label>
					</div>
					<div class="col-sm-10">
...
<div class="modal fade" id="delete_<?php echo $row['mid']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <center><h4 class="modal-title" id="myModalLabel">Delete Documentary</h4></center>
            </div>
            <div class="modal-body">	
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span> Cancel</button>
                <a href="docu-delete.php?id=<?php echo $row['mid']; ?>" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Yes</a>
            </div>
