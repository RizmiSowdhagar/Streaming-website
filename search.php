...
<head>
  ...
  text-align: center;' class='container-fluid'>
              ...
              echo"<h1 style='color:white;position:sticky;'>WELCOME </h1><i style = 'color: white;font-size: 25px'> ".ucwords($rel['name'])." </i>
                  </div>
                  </header>
                  <section>
                ...
                <div class='row'>
                  <div class='col'>
                    ...
                    <input style='color: black;font-size: 25px; font-family:Bookman Old Style;width:400px;' type='submit' name='submit' class='btn btn-success' style='display:inline;width:200px;margin-left:20px;margin-right:20px;' value='".ucwords($rel2['name'])."'/></h4>
                    </form>
      ...
      <div style="background-color: black;" class="jumbotron">
        <h2 style='margin-top:0px;padding-top:0px;color: white;margin-left: 25px;'>Results : </h2>
