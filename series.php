...
if (isset($_POST['submit'])) {
  ...
  include 'dbh.php';
  $im = "SELECT * FROM series WHERE name = '$title'" ;
  ...
  color:white;
    ...
    echo"<body>";
        ...
        while($result = mysqli_fetch_assoc($records)){
            ...
            $newcount = $current + 1;
            $newsql = "UPDATE series SET viewers = '$newcount' WHERE name='$mname' ";
          ...
          echo "<img src='uploads/".$result['imgpath']."' style='position:relative;position:absolute;width:270px;height:290px;margin-left:52%;'>";
             ...
             .$result['lang'].", ".$result['rdate'].", ".$result['director']."</h4>";
             ...
             echo"<br><h4 style='display: inline;font-family: Century Schoolbook;color:#cccccc;font-size:20px;position:relative;margin-left:22%;position:absolute;'>".ucwords($result['genre'])."</h4>";
