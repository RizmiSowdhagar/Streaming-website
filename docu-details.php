...
<head>
  ...
  text-align: center;' class='container-fluid'>
              ...
              echo"<h1 style='color:white;position:sticky;'>WELCOME </h1><b style = 'color: white;font-size: 25px'><i> ".ucwords($rel['name'])." </i></b>
                  ...
                  ?>
                  <h2 style='color:black;font-family: Century Schoolbook; margin-top: 45px;margin-left: 45px;'>Manage Documentaries</h2>
                  <div style="color: orange;border: 1px solid orange; margin: 30px;margin-right: 71%;margin-bottom: 50px;" ></div>
                  <div style="position: relative;bottom: 10%;" class="main">
<form style="position: absolute;left: 1px;" action="docu-search.php" method="POST">
  <input style="padding: 5px;" type="text" id="value" name="valueToSearch" placeholder="Value To Search"><br><br>
    ...
    <div style=" width: 40%" class="col-sm-8 col-sm-offset-2">
      <div style=" width: 40%;" class="row">
      <?php
        if(isset($_SESSION['error'])){
          echo
          "
          <div style=' display:inline; text-allign:center;' class='alert alert-danger text-center'>
        ...
        if(isset($_SESSION['success'])){
          echo
          "
          <div style='width:560px; display:inline-block;text-allign:center;' class='alert alert-success text-center'>
            <button class='close'>&times;</button>
            ".$_SESSION['success']."
          </div>
          ";
          ...
          <tbody>
            <?php
              ...
              while($row = $query->fetch_assoc()){
                ...
                "<tr>
                  ...
                  echo"<form action='docu-edit_delete_modal.php method='POST'>";
                  echo"<td>
           ...
           table{
            ...
            left:0;}
                ...
                include('docu-edit_delete_modal.php');
              }
...
<?php include('docu-add_modal.php') ?>
