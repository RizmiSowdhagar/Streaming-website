...
INSERT INTO `movies` (`mid`, `name`, `genre`, `rdate`, `runtime`, `lang`, `description`, `cast`, `director`,`rating`,`viewers`,
 `imgpath`, `videopath`) VALUES
(1, 'Pride and Prejudice', 'Melo-Drama ,Literary Fiction, Historical Romance, Satire', 'June 25, 2005', '2h 8 mins', 'English', 'Sparks fly when spirited 
...
class. Can each overcome their Pride and Prejudice? ',' Keira Knightley, Matthew Macfadyen','Joe Wright','7.8/10',
 ...
 (2, 'The Lion King', 'Animation, Adventure, Musical Drama', 'July 19,2019', '1h 28 mins','English', 'After the murder of his father, a young lion 
...
(3, 'The Maze Runneer', 'Action, Mystery, Sci-fi, Thriller', 'September 19, 2014', '1h 53 mins','English', 'Thomas is deposited in a community of 
...
a shot at escape.',' Dylan O Brien, Kaya Scodelario, Will Poulter',' Wes Ball','6.8/10', 1, 'The Maze Runner.jpg',
 'The Maze Runner.mp4'),
(4, 'Five Feet Apart', 'Drama, Romance', 'March 15, 2019', '1h 56 mins','English', 'A pair of teenagers with cystic fibrosis meet in a hospital and
...
(5, 'The Edge of Seventeen', 'Comedy, Drama', 'November 18, 2016', '1h 44 mins','Engish', 'High-school life gets even more unbearable for Nadine
...
(6, 'Avengers: Infinity War', 'Adventue, Action, Sci-Fi', 'April 27, 2018', '1h 58 mins','English', 'The Avengers and their allies must be willing
...
' Robert Downey Jr.,Chadwick Boseman,Chris Evans',' Anthony Russo, Joe Russo',
'8.4/10',1, 'Infinity War.jpg', 'Infinity War.mp4'),
(7, 'The Perks of Being a Wallflower', 'Drama, Romance', 'October 12, 2012', '1h 37 mins','English', 'An introvert freshman is taken under the 
...
(8,'Avengers: Endgame', 'Adventue, Action, Sci-Fi', 'April 26, 2019', '3h 1 mins','English', 'After the devastating events of Avengers: Infinity 
...
actions and restore balance to the universe.',' Robert Downey Jr.,Chadwick Boseman, Chris Hemsworth,Chris Evans',' Anthony Russo, Joe Russo','8.4/10',1, 'Avengers Endgame.jpg', 'Avengers Endgame.mp4'),
(9,'Sense and Sensibility', ' Melo-Drama, Romance ,Fantasy', 'January 26, 1996', '2h 16 mins','English', 'Rich Mr. Dashwood dies,
...
(10,'La La Land', ' Comedy, Drama, Music', 'December 25, 2016', '2h 7 mins','English', 'While navigating their careers in Los Angeles,
...
(11,'Finding Nemo',' Animation, Adventure, Comedy', 'May 30, 2003', '1h 40mins','English', 'After his son is captured in 
...
(12,'The Dark Knight', ' Action, Crime, Drama', 'July 18, 2008', '2h 32 mins','English', 'When the menace known as the Joker wreaks
...
'Dark Knight.mp4'),
(13,'Wonder Woman',' Action, Adventure, Fantasy', 'June 2, 2017', '2h 21 mins','English', 'When a pilot crashes and tells of conflict 
...
(14,'Beauty and the Beast','Family,Fantasy,Musical','March 17,2017','2h 9 mins','English','A selfish Prince is cursed to become a monster for
...
(15,'Jurassic Park',' Action, Adventure, Sci-Fi ','June 11, 1993','2h 36 mins','English','A pragmatic paleontologist visiting an almost complete theme
 park is tasked with protecting a couple of kids after a power failure causes the park cloned dinosaurs to run loose.','Sam Neill, Laura Dern,
  ...
  (16,'Dead Poets Society',' Comedy, Drama','9 June 1989','2h 10 mins','English','Maverick teacher John Keating uses poetry to embolden his
